      ...
      <div className='skillsandjobs'>
        ...
        <h5>Who we want to take with us to the next phase.</h5>
          <div className="skillsandjobs-content">
            ...
            <ul>
            <li>Design and develop the DuckyPass device's hardware, including component selection, PCB design, and testing.</li>
            <li>Collaborate with software engineers to ensure seamless integration between hardware and software components.</li>
            <li>Conduct testing and debugging of hardware components and systems to ensure optimal performance.</li>
          ...
          <div className="skillsandjobs-content">
            ...
            <p>Responsibilities include:</p>
            <ul>
            <li>Develop and optimize the firmware for the DuckyPass device to ensure optimal performance, security, and functionality.</li>
            <li>Develop and maintain the mobile app that connects to the DuckyPass device using Bluetooth.</li>
            <li>Conduct testing and debugging of the software components to ensure optimal performance and functionality.</li>
          ...
          <div className="skillsandjobs-content">
            ...
            <p>Responsibilities include:</p>
            <ul>
            <li>Define product requirements and features based on market research and customer feedback.</li>
            <li>Develop and maintain the product roadmap and ensure alignment with the company's overall strategy.</li>
            <li>Work closely with the hardware and software teams to ensure the development of high-quality, reliable, and innovative products.</li>
          ...
          <div className="skillsandjobs-content">
            ...
            <p>Responsibilities include:</p>
            <ul>
            <li>Develop and execute test plans to ensure the device meets the highest standards of quality and security.</li>
            <li>Conduct security testing to identify vulnerabilities and recommend solutions.</li>
            <li>Collaborate with the hardware and software teams to ensure seamless integration between hardware and software components.</li>
            <li>Conduct post-release testing and analysis to ensure the device is performing as expected and identify areas for improvement.</li>
            <li>Develop and maintain documentation related to testing and quality assurance.</li>
            </ul>
          </div>
        </div>
    </section>
